...
namespace LetterApp.iOS.Views.Login
{
	...
	partial class LoginViewController
	{
		...
		[Outlet]
		UIKit.UIView _emailLineView { get; set; }

		[Outlet]
		UIKit.UITextField _emailTextField { get; set; }

		[Outlet]
		UIKit.UIButton _forgotPassButton { get; set; }

		[Outlet]
		UIKit.UIView _formContainerView { get; set; }

		[Outlet]
		UIKit.NSLayoutConstraint _passwordHeightConstraint { get; set; }

		[Outlet]
		UIKit.UILabel _passwordLabel { get; set; }

		[Outlet]
		UIKit.UIView _passwordLineView { get; set; }

		[Outlet]
		UIKit.UITextField _passwordTextField { get; set; }

		[Outlet]
		UIKit.NSLayoutConstraint _passwordWithConstraint { get; set; }
