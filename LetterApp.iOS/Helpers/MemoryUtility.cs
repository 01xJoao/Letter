...
namespace LetterApp.iOS.Helpers
{
    ...
    public static class MemoryUtility
    {
        ...
        public static void ReleaseObject<T>(WeakReference<T> weakReference, bool enableSelfCleaning = true) where T : class, IDisposable
        {
            T reference;
        ...
        private static void ReleaseChildControllers(IEnumerable<UIViewController> children)
        {
            ...
            {
                ReleaseUIViewWithChildren(child.ViewIfLoaded);
                ReleaseObject(child);
            }
        }
        ...
        private static void ReleaseUIViewController(IDisposable disposableObject)
        {
            ...
            ReleaseUIViewWithChildren(viewController.ViewIfLoaded);
